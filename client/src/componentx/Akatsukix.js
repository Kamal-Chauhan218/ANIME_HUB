        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-col text-center w-full mb-20">
            ...
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
              ...
              of unofficial members, and all except for one are males. It was
              founded by Yahiko, and Konan with Nagato as the leader though he
              ...
              <div class="h-full  flex flex-col items-center text-center">
                ...
                <div class="w-full">
                  ...
                  <p class="mb-4 text-justify">
                    ...
                    able to remotely control their bodies like one of the Six
                    Paths.
                  </p>
                </div>
              </div>
              ...
              <div class="h-full flex flex-col items-center text-center">
                ...
                <div class="w-full">
                  ...
                  <p class="mb-4 text-justify">
                    ...
                    Obito is so overcome with grief that he awakens his Mangekyo
                    Sharingan.
                  </p>
                </div>
              </div>
              ...
              <div class="h-full flex flex-col items-center text-center">
                ...
                <div class="w-full">
                  ...
                  <p class="mb-4 text-justify">
                    ...
                    explosive, able to deal massive damage.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="h-full flex flex-col items-center text-center">
                ...
                <div class="w-full">
                  ...
                  <p class="mb-4 text-justify">
                    ...
                    numerous fatal injuries, and almost any form of
                    dismemberment
                  </p>
                </div>
              </div>
              ...
              <div class="h-full flex flex-col items-center text-center">
                ...
                <div class="w-full">
                  ...
                  <p class="mb-4 text-justify">
                    ...
                    remove their organs and integrate them into his own body,
                    thereby extending his life.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="h-full flex flex-col items-center text-center">
                ...
                <div class="w-full">
                  ...
                  <p class="mb-4 text-justify">
                    ...
                    he has been able to add some snake-like characteristics to
                    his own body.
                  </p>
                </div>
              </div>
              ...
              <div class="h-full flex flex-col items-center text-center">
                ...
                <div class="w-full">
                  ...
                  <p class="mb-4 text-justify">
                    ...
                    Shikigami, which can turn her entire body and clothing into
              ...
              <div class="h-full flex flex-col items-center text-center">
                ...
                <div class="w-full">
                  ...
                  <p class="mb-4 text-justify">
                    ...
                    for ordinary shinobi. Sasori can also control living people
                    as puppets
                  </p>
                </div>
              </div>
              ...
              <div class="h-full flex flex-col items-center text-center">
                ...
                <div class="w-full">
                  ...
                  <p class="mb-4 text-justify">
                    ...
                    attacks. His shark-like attributes carried over into
                    techniques.
                  </p>
                </div>
              </div>
              ...
              <div class="h-full flex flex-col items-center text-center">
                ...
                <div class="w-full">
                  ...
                  <p class="mb-4 text-justify">
                    ...
                    around several individuals at once
                  </p>
                </div>
              </div>
            </div>
